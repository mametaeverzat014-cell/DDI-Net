...
FINAL_DIR = ROOT / "reports" / "v2_baselines"
VALIDATION_CSV = FINAL_DIR / "m0_validation.csv"
CHECKPOINTS = FINAL_DIR / "checkpoints"

S3_CSV = FINAL_DIR / "m0_test_s3.csv"
PRED_CSV = FINAL_DIR / "m0_test_pair_predictions.csv"

EXPECTED_CONFIG_ID = "77926ed46926273d"
...
def load_specs():
    ...
    return [replace(x, ablation="M0") for x in module.load_specs()]
